...
trait phReadDataTwelveTitle {
    ...
    def formatDF(path: String): DataFrame = {
        ...
        val resultTitlelst = titlelst.slice(0, 6) ::: List("COMPS_ABB", "COMPS_DESC") ::: titlelst.slice(6, title_size) ::: List("UNIT_TYPE")
        ...
        val resultDF = hasTitleDF.withColumn("UNIT_TYPE", lit(unitType))
            .withColumn("COMPS_ABB", lit(0))
            .withColumn("COMPS_DESC", lit("defult"))
